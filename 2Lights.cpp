...
//        vec3 materialDiffuse = vec3(0.5, 1.0, 0.31);
//        vec3 materialSpecular = vec3(0.5, 0.5, 1.0);
...
//    GLFWwindow* window = glfwCreateWindow(800, 600, "Cube with multiple lights", nullptr, nullptr);
//
...
//    vec3 lightAmbient(1.0f, 1.0f, 0.0f); 
//   
//    vec3 lightDiffuse(1.0f, 0.0f, 1.0f);
